...
This dataset explores student achievement in secondary education across two Portuguese schools. Collected through school reports and questionnaires, it includes attributes such as student grades, demographic information, and social and school-related features. The target attribute, "G3" represents the final year grade issued at the 3rd period. The data set contains 395 rows and 33 columns, with each row representing a different observation and each column represents a different feature.
...
8)Medu: mother's education (numeric: 0 - none, 1 - primary education (4thgrade), 2 - “ 5th to 9th grade, 3 - “ secondary education or 4 - “ higher education)
